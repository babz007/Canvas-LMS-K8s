# Use the Instructure Ruby Passenger base image
ARG RUBY=3.1
...
# Install Bundler and Bundler plugins
RUN gem install bundler --no-document -v 2.5.10 \
  && gem install bundler-multilock \
...
RUN set -eux; \
  mkdir -p \
    ...
    tmp \
    /home/docker/.bundle/ \
    /home/docker/.bundle/plugin \
    /home/docker/.cache/yarn \
    /home/docker/.gem/ \
    /usr/src/app/vendor/gems/bundler-multilock

# Copy the necessary files for bundling
COPY Gemfile Gemfile.lock ./
COPY vendor/gems/bundler-multilock /usr/src/app/vendor/gems/bundler-multilock
COPY config/canvas_rails_switcher.rb config/canvas_rails_switcher.rb

# Debug: List contents to verify copy
RUN ls -l /usr/src/app/vendor/gems/bundler-multilock

# Set permissions
RUN chown -R docker:docker $APP_HOME /home/docker/.bundle /home/docker/.gem /usr/src/app/vendor/gems/bundler-multilock
